...
\begin{frame}{Schema}
   \begin{tikzpicture}[scale=0.71]
	...
	\coordinate (B5_R) at (11,-7);
   	...
   	\shade[top color=orange,bottom color=black] (B2_L) rectangle (B2_R) node[midway,below] {Backend of Platform};
   	\shade[top color=brown,bottom color=black] (B3_L) rectangle (B3_R) node[midway,below] {Platform};
   	\shade[top color=red,bottom color=black] (B4_L) rectangle (B4_R) node[midway,below] {RegisterTaskInterface};
   	\shade[top color=green,bottom color=black] (B5_L) rectangle (B5_R) node[midway,below] {CRUD on Data Interface};
...
\begin{frame}
   \begin{tikzpicture}[scale=0.71]
	...
	\shade[top color=yellow,bottom color=black] (B1_L) rectangle (B1_R) node[midway,below] {ZookeeperBP implemenets Backend(BP)};
   	\shade[top color=orange,bottom color=black] (B2_L) rectangle (B2_R) node[midway,below] {NameSpaceInterface};
   	\shade[top color=orange,bottom color=black] (B3_L) rectangle (B3_R) node[midway,below] {Platform};
	\drawLinkArrow{B1_L}{B1_R}{B2_L}{B2_R}
	\drawLinkArrow{B2_L}{B2_R}{B3_L}{B3_R}
...
\begin{frame}{AWS capacity application}
  \begin{example}
	...
	\begin{tikzpicture}[scale=0.51]
		...
		\shade[top color=yellow,bottom color=black] (B1_L) rectangle (B1_R) node[midway,below] {Aws Capacity Application};
		\shade[top color=orange,bottom color=black] (B2_L) rectangle (B2_R) node[midway,below] {Aws LeaderTask};
		\shade[top color=orange,bottom color=black] (B3_L) rectangle (B3_R) node[midway,below] {Aws FollowerTask};
		\drawLinkArrow{B1_L}{B1_R}{B2_L}{B2_R}
